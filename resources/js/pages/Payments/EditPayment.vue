...
<template>
    <div class="p-6">
        ...
        <form @submit.prevent="submit" enctype="multipart/form-data" class="max-w-xl mx-auto">
            <div class="mb-5">
                <label for="room_tenant_id" class="block mb-2 text-sm font-medium text-gray-900">Payee Tenant</label>
            ...
            <div class="mb-5">
                <label for="billing_period" class="block mb-2 text-sm font-medium text-gray-900">Periode Tagihan</label>
            ...
            <div class="mb-5">
                <label for="penalty_fee" class="block mb-2 text-sm font-medium text-gray-900">Denda (Jika Ada)</label>
            ...
            <div class="mb-5">
                <label for="payment_photo" class="block mb-2 text-sm font-medium text-gray-900">Foto Pembayaran</label>
